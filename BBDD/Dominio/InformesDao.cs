...
namespace BBDD.Dominio
{
    internal class InformesDao
    {
        ...
        // ── INFORME 1: Nóminas de un mes ordenadas de mayor a menor bruto ──
        ...
        public DataTable GetNominasPorMes(int anio, int mes, int idOficina)
        {
            ...
            string filtroOficina = (idOficina != -1)
                ? " AND o.idOffice = " + idOficina
                : "";

            string sql =
                "SELECT e.empName, o.offCity, mp.payYear, mp.payMonth, " +
        ...
        // ── INFORME 2: Todas las nóminas de un empleado ────────────────────
